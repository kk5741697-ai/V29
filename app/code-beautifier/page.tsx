...
function processCodeBeautifier(input: string, options: any = {}) {
  try {
...
export default function CodeBeautifierPage() {
  return (
    <TextToolLayout
      ...
      processFunction={processCodeBeautifier}
      validateFunction={validateCode}
      options={codeBeautifierOptions}
      examples={codeBeautifierExamples}
